        ...
        >
          ...
          <div className="flex justify-center">
            <button
              ...
              class="bg-sky-800 mt-8 text-white text-base py-2 px-4 rounded focus:outline-none focus:shadow-outline transform transition scale-90 hover:scale-100 duration-500 ease-in-out"
            >
              Log in
            </button>
            <button
              ...
              style={{ fontFamily: "Ubuntu" }}
              class="bg-white mt-8 text-black border border-gray-900/40 text-base py-2 px-4 rounded focus:outline-none focus:shadow-outline transform transition scale-90 hover:scale-100 duration-500 ease-in-out"
            >
              Sign up
            </button>
          </div>
        ...
        >
          ...
          <div className="flex flex-col justify-center w-[55%]">
            ...
            <button
              ...
              style={{ fontFamily: "Ubuntu" }}
              class="bg-sky-700 text-white mt-6 border border-sky-900/40 text-base py-4 px-6 mx-3 rounded focus:outline-none focus:shadow-outline transform transition hover:bg-sky-600 duration-500 ease-in-out"
            >
              Submit
            </button>
          </div>
